...
## 📝 Criterios de Evaluación - Estado Actual

| Criterio | Peso | Estado | Detalles |
|----------|------|--------|----------|
| **Organización** | 10% | ✅ 10/10 | Estructura clara, README completo, commits en inglés |
| **Modelado y geometría procedural** | 10% | ✅ 10/10 | 4 algoritmos, comparativa documentada, código limpio |
| **Materiales e iluminación PBR** | 15% | ✅ 15/15 | Texturas completas, 3-point lighting, HDRI |
| **Shaders y texturizado dinámico** | 15% | 🚧 0/15 | Planificado para Punto 3 |
| **Interacción multimodal** | 15% | 🚧 0/15 | Planificado para Puntos 7-9 |
| **Cámaras y proyección** | 10% | ✅ 10/10 | Perspectiva/Ortográfica, OrbitControls, animaciones |
| **Animaciones y partículas** | 10% | ✅ 8/10 | TWEEN animations, falta partículas (Punto 4) |
| **Evidencias visuales** | 10% | ✅ 10/10 | 3 screenshots, 2 GIFs, 2 videos |
| **Código y documentación** | 5% | ✅ 5/5 | Comentarios, 8 commits, docs separadas |
| **TOTAL** | **100%** | **✅ 68%** | **68/100 puntos** |

**Progreso**: 2 de 11 puntos completados (18.2% del taller)  
**Calidad actual**: Excelente (68/68 posibles en Puntos 1-2)
...
- **Taller Anterior**: [Taller 1 - Materiales e Iluminación](../2025-10-05_taller_1_materiales_iluminacion_color/)
